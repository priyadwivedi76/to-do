      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-96">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            className="w-full text-gray-600 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
            required
          />
          <input
            type="password"
          ...
          <button 
            type="submit" 
            className="w-full text-gray-600 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">
            Sign Up
          </button>
        </form>
